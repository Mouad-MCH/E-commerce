...
const productPatch = productCreateSchema.partial();

const buildProductUpdateSet = (body: z.infer<typeof productPatch>) => {
...
export const getImageKitAuth = (_req: Request, res: Response, next: NextFunction) => {
    try {
